...
def generate_pages_recursively(dir_path_content="content", dir_template_path="template.html", dest_dir_path="public"):
    for root, dirs, files in os.walk(dir_path_content):
        for file in files:
            if file.endswith(".md"):
                ...
                generate_page(from_path, dir_template_path, dest_path)
